...
ret, thresh = cv2.threshold(cv2.cvtColor(img.copy(), cv2.COLOR_BGR2GRAY), 100, 180, cv2.THRESH_BINARY)
...
contours, hierarchv = cv2.findContours(thresh, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
'''
for c in contours:
    # 轮廓绘制方法一
